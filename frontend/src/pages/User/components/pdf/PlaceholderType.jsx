...
function PlaceholderType(props) {
  ...
  const widgetTypeTranslation = (`widgets-name.${props?.pos?.type}`);
  ...
  const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
    ...
    >
      ...
      <CalendarMonth fontSize="20" className="fa-light fa-calendar ml-[5px]"></CalendarMonth>
    </div>
  ));
  ...
  switch (type) {
      ...
      return props.pos.SignUrl ? (
        ...
        <div className={widgetCls}>
          {props.pos.type && (
            ...
            >
              {props.isNeedSign
                ? props.pos?.options?.hint || "signature"
                : "signature"}
            </div>
          )}
        </div>
    ...
    case textInputWidget:
      return props.isSignYourself ||
        ...
        <textarea
          ref={inputRef}
          placeholder={validatePlaceholder || ("widgets-name.text")}
          rows={1}
