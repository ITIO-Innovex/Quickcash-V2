...
function SignYourSelf() {
  ...
  const steps = [
    {
      selector: '[data-tut="document-viewer"]',
      content: "This is where you can view and interact with your document",
    },
    {
      selector: '[data-tut="widget-component"]',
      content: "Add signatures, initials, or other elements to your document",
    },
    {
      selector: '[data-tut="pdf-header"]',
      content: "Use these controls to navigate and manage your document",
    },
    {
      selector: '[data-tut="pdf-zoom"]',
      content: "Adjust the zoom level and rotation of your document",
    }
  ];

  // Start tour immediately when component mounts
  useEffect(() => {
              ...
              <div className=" w-full md:w-[57%] flex mr-4">
                ...
                <div className="w-full md:w-[95%]">
                  ...
                  <Header
                    ...
                    data-tut="pdf-header"
                  />
                  <div ref={divRef} data-tut="document-viewer" className="h-full">
