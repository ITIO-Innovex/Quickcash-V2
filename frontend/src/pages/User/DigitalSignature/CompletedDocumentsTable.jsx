...
const CompletedDocumentsTable = () => {
  ...
  const [currentDocumentDetails, setCurrentDocumentDetails] = useState(null);
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const response = await axios.post(
        'http://localhost:5000/api/v1/digital-signature/documents/get-report?statusFilter=completed',
        // 'https://quickcash.oyefin.com/api/v1/digital-signature/documents/get-report?statusFilter=completed',
        {
          userid: userId,
          skip: page * rowsPerPage,
          limit: rowsPerPage,
              ...
              <TableRow key={document._id}>
                ...
                <TableCell>
                  ...
                  <Tooltip title="View Certificate">
                    <IconButton
                      onClick={() => window.open(document.CertificateUrl, '_blank')}
                    >
